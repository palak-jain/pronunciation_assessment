...
form Give the parameters for pause analysis
   ...
   positive Minimum_duration_(seconds) 2.0
   positive Maximum_intensity_(dB) 50
   ...
   comment Give the window size for the intensity analyses (smaller window requires less memory):
	 positive Window_size_(seconds) 15
   ...
   comment Save TextGrid file to folder:
	text folder /Users/Palak/Desktop/Rnd/data/teacher_downsampled/Bunty_And_Bubbly_0_sent/
